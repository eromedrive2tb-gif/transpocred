<?php
/**
 * Molecule/Social: OpenGraph — meta tags og:* para compartilhamento em redes sociais.
 * Responsabilidade única: dados de preview para Facebook, LinkedIn e plataformas OG-compatíveis.
 */
?>
